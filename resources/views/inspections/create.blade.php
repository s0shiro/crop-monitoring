<x-app-layout>
    <div class="max-w-2xl mx-auto p-6">
        <!-- Header Section -->
        <div class="mb-8">
            <h2 class="text-3xl font-bold text-base-content">Record Crop Inspection</h2>
            <p class="text-base-content/70 mt-1">Add inspection details for the crop planting</p>
        </div>

        <!-- Form Card -->
        <div class="card bg-base-100 shadow-xl">
            <div class="card-body">
                <form action="{{ route('crop_inspections.store', $planting->id) }}" method="POST" class="space-y-6">
                    @csrf
                    ...
                    <div class="form-control">
                        ...
                        <textarea name="remarks"
                                  ...
                                  placeholder="Enter any additional observations or notes">{{ old('remarks') }}</textarea>
                    </div>
